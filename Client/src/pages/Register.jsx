  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8 overflow-hidden bg-slate-900">
      ...
      <div className="absolute inset-0 bg-slate-900 z-0">
        <div className="absolute bottom-[-20%] left-[-10%] w-[70%] h-[70%] bg-purple-600/30 rounded-full blur-[120px] animate-pulse"></div>
        <div className="absolute top-[-20%] right-[-10%] w-[60%] h-[60%] bg-indigo-600/30 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-5xl flex flex-col md:flex-row-reverse bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl overflow-hidden">
        
        {/* Right Side: Branding / Intro (Hidden on very small screens, visible on md+) */}
        <div className="hidden md:flex md:w-1/2 flex-col justify-between p-10 lg:p-14 bg-gradient-to-bl from-indigo-900 to-purple-900 relative overflow-hidden border-l border-white/10 text-right group">
          ...
          <div className="absolute inset-0 z-0 opacity-40 mix-blend-overlay flex gap-4 p-4 transform rotate-[12deg] scale-[1.3] pointer-events-none group-hover:opacity-70 transition-opacity duration-700">
             ...
             <div className="flex flex-col gap-4 animate-[slideUp_22s_linear_infinite] group-hover:[animation-play-state:paused]">
                <img src="https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=400&q=80" className="w-48 h-64 object-cover rounded-2xl shadow-xl" alt="" />
                <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=400&q=80" className="w-48 h-48 object-cover rounded-2xl shadow-xl" alt="" />
             ...
             {/* Column 2 */}
             <div className="flex flex-col gap-4 animate-[slideDown_20s_linear_infinite] mt-[-150px] group-hover:[animation-play-state:paused]">
                ...
                <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?w=400&q=80" className="w-48 h-64 object-cover rounded-2xl shadow-xl" alt="" />
                <img src="https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?w=400&q=80" className="w-48 h-72 object-cover rounded-2xl shadow-xl" alt="" />
             </div>
             {/* Column 3 */}
             <div className="flex flex-col gap-4 animate-[slideUp_25s_linear_infinite] group-hover:[animation-play-state:paused]">
                <img src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=400&q=80" className="w-48 h-48 object-cover rounded-2xl shadow-xl" alt="" />
          ...
          <div className="relative z-10 flex flex-col items-end">
            ...
            <p className="text-indigo-100 text-lg leading-relaxed max-w-sm">
              Create an account to start booking rooms, discovering amazing events, and shaping your daily university experience.
            </p>
          </div>
          
          <div className="mt-12 flex justify-end">
             <div className="bg-white/10 backdrop-blur-md p-5 rounded-2xl border border-white/20 text-left max-w-sm">
               <div className="flex items-center gap-2 mb-2 text-yellow-400">
                 ★★★★★
               </div>
               <p className="text-white text-sm font-medium">"Campus360 completely transformed how I navigate uni life!"</p>
               <p className="text-indigo-200 text-xs mt-3 font-semibold">— Sarah, Computer Science</p>
             </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-6 sm:p-10 lg:p-16 flex flex-col justify-center bg-white relative">
          ...
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="text-center md:text-left mb-8">
              ...
              <p className="text-gray-500">Create your student account today</p>
            </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <button 
              type="submit"
              disabled={loading}
              className="w-full flex justify-center py-4 px-4 border border-transparent rounded-xl shadow-lg text-sm font-bold text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all transform hover:scale-[1.01] disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none mt-2"
            >
              {loading ? (
